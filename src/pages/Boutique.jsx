    ...
    <div className='w-screen'>
        <DefaultLayout>
          ...
          <div className='flex flex-col lg:flex-row bg-black justify-center w-screen lg:h-[450px]'>
              ...
              <div className='bg-croche  w-full h-[200px] lg:h-auto bg-no-repeat bg-cover bg-center flex justify-center items-center text-white font-jose text-5xl'>
                  <Link to="/tienda">
          ...
          <div className='flex flex-col lg:flex-row bg-black justify-center w-screen lg:h-[450px]'>
            ...
            <div className='bg-seamless  w-full h-[200px] lg:h-auto bg-no-repeat bg-cover flex justify-center items-center text-white font-jose text-5xl'>
                  <Link to="/tienda">
